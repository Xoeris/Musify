...
public class UltraSong {
    ...
    public UltraSong(String title, String artist, String path, String duration, String l) throws IOException {
        this.path = path;
    ...
    public static List<UltraSong> filterSongs(List<UltraSong> ultraSongs, String query) {
        List<UltraSong> filtered = new ArrayList<>();
        String lowerQuery = query.toLowerCase().trim();
        for (UltraSong ultraSong : ultraSongs) {
            if (ultraSong.matchesSearch(lowerQuery)) {
                filtered.add(ultraSong);
            }
        }
        return filtered;
    }
